...
from modules.fusion.linear_fusion_head.base_fusion_head import BaseFusionHead
...
class AttentionFusionHead(BaseFusionHead):
    ...
    def forward(self, source1, source2, source3):
        ...
        fusion_output, _ = self.fusion_attention(concatenated_inputs, concatenated_inputs,
                                                 concatenated_inputs)  # (batch_size, 3 * seq_len, vector_dim)
